...
namespace AbaqusExtension
{
    public class Matrix
    {
        ...
        public static Matrix Diag(Matrix diag_vector, int offset)
        {
            ...
            //    throw new ArgumentException("Absolute sourceValue of offset must be less than length of diag_vector.");
        ...
        public virtual Complex this[int i, int j]
        {
            set
            {
                ...
                //this.Values[i - 1, j - 1] = sourceValue; 
            }
            get
            {
        ...
        public virtual double this[int i, int j, bool dummy = true]
        {
            get
            {
                if (i >= 0 && i < rowCount && j >= 0 && j < columnCount)
